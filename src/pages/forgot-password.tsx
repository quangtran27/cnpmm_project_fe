...
export default function ForgotPassword() {
  ...
  return (
    <section className='h-screen bg-gray-100 bg-auth bg-cover bg-no-repeat pt-1'>
      <div className='mx-auto mt-[50%] flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0'>
